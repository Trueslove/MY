...
interface PlusAndroid {
    ...
    /**
     * 请求权限
     * 向系统请求权限，Android系统版本&gt;=23，targetSdkVersion&gt;=23时，如果权限属于危险权限并且用户没有授权则会弹出系统提示框由用户授权确认。。
     * 	授权结果在successCb回调参数中可获取。
     * 
     * 参考: [http://www.html5plus.org/doc/zh_cn/android.html](http://www.html5plus.org/doc/zh_cn/android.html)
     */
    requestPermissions(permissions?: any [], successCb?: (result: any) => void, errorCB?: (result: any) => void): void;
    /**
     * 获取应用主Activity实例对象
    ...
    /**
     * 自动回收对象
     * 设置自动回收原生对象，应用在恰当的时候（如应用结束运行时）自动释放对象占用的资源。
     * 
     * 参考: [http://www.html5plus.org/doc/zh_cn/android.html](http://www.html5plus.org/doc/zh_cn/android.html)
     */
...
interface PlusAudio {
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/audio.html](http://www.html5plus.org/doc/zh_cn/audio.html)
     */
    createPlayer(styles?: PlusAudioAudioPlayerStyles): PlusAudioAudioPlayer;
}
...
interface PlusContacts {
    ...
    /**
     * SIM卡通讯录
     * 通讯录类型常量，数值类型，固定值为1，用于获取SIM卡上的联系人信���。
     * 
     * 参考: [http://www.html5plus.org/doc/zh_cn/contacts.html](http://www.html5plus.org/doc/zh_cn/contacts.html)
     */
...
interface PlusDevice {
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/device.html](http://www.html5plus.org/doc/zh_cn/device.html)
     */
    getInfo(success?: (result: any) => void, fail?: (result: any) => void, complete?: (result: any) => void): void;
    /**
     * 获取设备的系统音量
...
interface PlusDownloader {
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/downloader.html](http://www.html5plus.org/doc/zh_cn/downloader.html)
     */
    enumerate(enumCB?: (result: any []) => void, state?: '0' | '1' | '2' | '3' | '4' | '5' | '-1'): void;
    /**
     * 清除下载任务
     * 清除指定状态的下载任务。
     * 
...
interface PlusGallery {
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/gallery.html](http://www.html5plus.org/doc/zh_cn/gallery.html)
     */
    save(path  ?: '_doc/' | '_documents/' | '_downloads/', succesCB?: (result: PlusGalleryGallerySaveEvent) => void, errorCB?: (result: any) => void): void;
}
...
interface PlusIo {
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/io.html](http://www.html5plus.org/doc/zh_cn/io.html)
     */
    convertLocalFileSystemURL(url?: '_www/' | '_doc/' | '_documents/' | '_downloads/'): string;
    /**
     * 将平台绝对路径转换成本地URL路径
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/io.html](http://www.html5plus.org/doc/zh_cn/io.html)
     */
    getAudioInfo(filePath?: string, success?: (result: any) => void, fail?: (result: any) => void, complete?: (result: any) => void): void;
    /**
     * 获取文件信息
     * 支持获取本地文件信息。
     * 
     * 参考: [http://www.html5plus.org/doc/zh_cn/io.html](http://www.html5plus.org/doc/zh_cn/io.html)
     */
    getFileInfo(filePath?: string, digestAlgorithm?: string, success?: (result: any) => void, fail?: (result: any) => void, complete?: (result: any) => void): void;
    /**
     * 获取图片信息
     * 支持获取本地图片和网络图片的信息。
     * 
     * 参考: [http://www.html5plus.org/doc/zh_cn/io.html](http://www.html5plus.org/doc/zh_cn/io.html)
     */
    getImageInfo(src?: string, success?: (result: any) => void, fail?: (result: any) => void, complete?: (result: any) => void): void;
    /**
     * 获取视频文件信息
     * 仅支持获取本地视频文件信息。
     * 
     * 参考: [http://www.html5plus.org/doc/zh_cn/io.html](http://www.html5plus.org/doc/zh_cn/io.html)
     */
    getVideoInfo(filePath?: string, success?: (result: any) => void, fail?: (result: any) => void, complete?: (result: any) => void): void;
}
...
interface PlusMessagingMessage {
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/messaging.html](http://www.html5plus.org/doc/zh_cn/messaging.html)
     */
    addAttachment(url?: '_www/' | '_doc/' | '_documents/' | '_downloads/'): void;
}
...
interface PlusNativeObjView {
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/nativeobj.html](http://www.html5plus.org/doc/zh_cn/nativeobj.html)
     */
    setTouchEventRect(rect?: any []): void;
    /**
     * 隐藏View控件
...
interface PlusNativeUI {
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/nativeui.html](http://www.html5plus.org/doc/zh_cn/nativeui.html)
     */
    confirm(message?: string, confirmCB?: (result: any) => void, styles?: PlusNativeUIConfirmStyles, buttons?: any []): void;
    /**
     * 关闭系统等待对话框
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/nativeui.html](http://www.html5plus.org/doc/zh_cn/nativeui.html)
     */
    previewImage(urls?: any [], styles?: PlusNativeUIPreviewImageStyles): void;
    /**
     * 显示系统等待对话框
...
interface PlusRuntime {
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/runtime.html](http://www.html5plus.org/doc/zh_cn/runtime.html)
     */
    install(filePath?: '_www/' | '_doc/' | '_documents/' | '_downloads/', options?: PlusRuntimeWidgetOptions, installSuccessCB?: (result: PlusRuntimeWidgetInfo) => void, installErrorCB?: (result: any) => void): void;
    /**
     * 退出应用
     * 5+APP：退出应用，返回系统桌面；
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/runtime.html](http://www.html5plus.org/doc/zh_cn/runtime.html)
     */
    openFile(filepath?: '_www/' | '_doc/' | '_documents/' | '_downloads/', options?: PlusRuntimeOpenFileOptions, errorCB?: (result: any) => void): void;
    /**
     * 处理直达页面链接参数
...
interface PlusSqlite {
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/sqlite.html](http://www.html5plus.org/doc/zh_cn/sqlite.html)
     */
    openDatabase(name?: string, path?: string, success?: (result: any) => void, fail?: (result: any) => void): void;
    /**
     * 判断数据库是否打开
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/sqlite.html](http://www.html5plus.org/doc/zh_cn/sqlite.html)
     */
    isOpenDatabase(name?: string, path?: string): boolean;
    /**
     * 关闭数据库
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/sqlite.html](http://www.html5plus.org/doc/zh_cn/sqlite.html)
     */
    closeDatabase(name?: string, success?: (result: any) => void, fail?: (result: any) => void): void;
    /**
     * 执行事务
     * 
     * 参考: [http://www.html5plus.org/doc/zh_cn/sqlite.html](http://www.html5plus.org/doc/zh_cn/sqlite.html)
     */
    transaction(name?: string, operation?: string, success?: (result: any) => void, fail?: (result: any) => void): void;
    /**
     * 执行增删改等操作的SQL语句
     * 
     * 参考: [http://www.html5plus.org/doc/zh_cn/sqlite.html](http://www.html5plus.org/doc/zh_cn/sqlite.html)
     */
    executeSql(name?: string, sql?: string, success?: (result: any) => void, fail?: (result: any) => void): void;
    /**
     * 执行查询的SQL语句
     * 
     * 参考: [http://www.html5plus.org/doc/zh_cn/sqlite.html](http://www.html5plus.org/doc/zh_cn/sqlite.html)
     */
    selectSql(name?: string, sql?: string, success?: (result: any) => void, fail?: (result: any) => void): void;
}
...
interface PlusVideoVideoPlayer {
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/video.html](http://www.html5plus.org/doc/zh_cn/video.html)
     */
    addEventListener(event?: 'play' | 'pause' | 'ended' | 'timeupdate' | 'fullscreenchange' | 'waiting' | 'error', listener?: (result: any) => void, capture?: boolean): void;
    /**
     * 设置视频播放控件参数
     * 用于动态更新视频播放控件的配置参数。
...
interface PlusWebview {
    ...
    /**
     * 窗口标题栏控件样式
     * 标题栏控件固定高度为44px,可通过Webview窗口对象的getTitleNView方法获取标题栏原生控件对象
     * 
     * 参考: [http://www.html5plus.org/doc/zh_cn/webview.html](http://www.html5plus.org/doc/zh_cn/webview.html)
     */
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/webview.html](http://www.html5plus.org/doc/zh_cn/webview.html)
     */
    close(id_wvobj?: string, aniClose?: 'auto' | 'none' | 'slide-out-right' | 'slide-out-left' | 'slide-out-top' | 'slide-out-bottom' | 'fade-out' | 'zoom-in' | 'zoom-fade-in' | 'flip-x' | 'flip-rx' | 'flip-y' | 'flip-ry' | 'page-backward' | 'pop-out', duration?: number, extras?: PlusWebviewWebviewExtraOptions): void;
    /**
     * 创建新的Webview窗口
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/webview.html](http://www.html5plus.org/doc/zh_cn/webview.html)
     */
    create(url?: '_www/' | '_doc/' | '_documents/' | '_downloads/', id?: string, styles?: PlusWebviewWebviewStyles, extras?: any): PlusWebviewWebviewObject;
    /**
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/webview.html](http://www.html5plus.org/doc/zh_cn/webview.html)
     */
    hide(id_wvobj?: string, aniHide?: 'auto' | 'none' | 'slide-out-right' | 'slide-out-left' | 'slide-out-top' | 'slide-out-bottom' | 'fade-out' | 'zoom-in' | 'zoom-fade-in' | 'flip-x' | 'flip-rx' | 'flip-y' | 'flip-ry' | 'page-backward' | 'pop-out', duration?: number, extras?: PlusWebviewWebviewExtraOptions): void;
    /**
     * 创建并打开Webview窗口
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/webview.html](http://www.html5plus.org/doc/zh_cn/webview.html)
     */
    open(url?: '_www/' | '_doc/' | '_documents/' | '_downloads/', id?: string, styles?: PlusWebviewWebviewStyles, aniShow?: 'auto' | 'none' | 'slide-in-right' | 'slide-in-left' | 'slide-in-top' | 'slide-in-bottom' | 'fade-in' | 'zoom-out' | 'zoom-fade-out' | 'flip-x' | 'flip-rx' | 'flip-y' | 'flip-ry' | 'page-forward' | 'pop-in', duration?: number, showedCB?: () => void): PlusWebviewWebviewObject;
    /**
     * 预载网络页面
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/webview.html](http://www.html5plus.org/doc/zh_cn/webview.html)
     */
    show(id_wvobj?: string, aniShow?: 'auto' | 'none' | 'slide-in-right' | 'slide-in-left' | 'slide-in-top' | 'slide-in-bottom' | 'fade-in' | 'zoom-out' | 'zoom-fade-out' | 'flip-x' | 'flip-rx' | 'flip-y' | 'flip-ry' | 'page-forward' | 'pop-in', duration?: number, showedCB?: () => void, extras?: PlusWebviewWebviewExtraOptions): PlusWebviewWebviewObject;
    /**
     * Webview窗口组合动画
...
interface PlusWebviewWebviewObject {
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/webview.html](http://www.html5plus.org/doc/zh_cn/webview.html)
     */
    overrideResourceRequest(options?: any []): void;
    /**
     * 拦截Webview窗口的URL请求
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/webview.html](http://www.html5plus.org/doc/zh_cn/webview.html)
     */
    setSoftinputTemporary(mode?: any): void;
    /**
     * 设置Webview窗口的样式
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/webview.html](http://www.html5plus.org/doc/zh_cn/webview.html)
     */
    updateSubNViews(styles?: any []): void;
}
...
interface PlusBarcode {
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/barcode.html](http://www.html5plus.org/doc/zh_cn/barcode.html)
     */
    scan(path?: '_www/' | '_doc/' | '_documents/' | '_downloads/', successCB?: (result0: number, result1: string, result2: string) => void, errorCB?: (result: any) => void, filters?: 'plus.barcode.QR' | 'plus.barcode.EAN13' | 'plus.barcode.EAN8' | 'plus.barcode.AZTEC' | 'plus.barcode.DATAMATRIX' | 'plus.barcode.UPCA' | 'plus.barcode.UPCE' | 'plus.barcode.CODABAR' | 'plus.barcode.CODE39' | 'plus.barcode.CODE93' | 'plus.barcode.CODE128' | 'plus.barcode.ITF' | 'plus.barcode.MAXICODE' | 'plus.barcode.PDF417' | 'plus.barcode.RSS14' | 'plus.barcode.RSSEXPANDED'): void;
    /**
     * 创建扫码识别控件对象
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/barcode.html](http://www.html5plus.org/doc/zh_cn/barcode.html)
     */
    create(id?: string, filters?: 'plus.barcode.QR' | 'plus.barcode.EAN13' | 'plus.barcode.EAN8' | 'plus.barcode.AZTEC' | 'plus.barcode.DATAMATRIX' | 'plus.barcode.UPCA' | 'plus.barcode.UPCE' | 'plus.barcode.CODABAR' | 'plus.barcode.CODE39' | 'plus.barcode.CODE93' | 'plus.barcode.CODE128' | 'plus.barcode.ITF' | 'plus.barcode.MAXICODE' | 'plus.barcode.PDF417' | 'plus.barcode.RSS14' | 'plus.barcode.RSSEXPANDED', styles?: PlusBarcodeBarcodeStyles): PlusBarcodeBarcode;
    /**
     * 查找扫码识别控件对象
...
interface PlusOauth {
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/oauth.html](http://www.html5plus.org/doc/zh_cn/oauth.html)
     */
    getServices(successCB?: (result: any []) => void, errorCB?: (result: any) => void): void;
}
...
interface PlusPaymentPaymentChannel {
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/payment.html](http://www.html5plus.org/doc/zh_cn/payment.html)
     */
    requestOrder(ids?: any [], successCB?: (result: any []) => void, errorCB?: (result: any) => void): void;
    /**
     ...
     * 参考: [http://www.html5plus.org/doc/zh_cn/payment.html](http://www.html5plus.org/doc/zh_cn/payment.html)
     */
    restoreComplateRequest(options?: any, successCB?: (result: any []) => void): void;
}
