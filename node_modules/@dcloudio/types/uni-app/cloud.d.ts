declare namespace UniCloud {
    interface Db {
         ...
         * 数据库集合引用
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=获取集合的引用](http://uniapp.dcloud.io/uniCloud/cf-database?id=获取集合的引用)
         */
    ...
    interface AggregateCommand {
        ...
        /**
         * 在目标字符串中查找子字符串，并返回第一次出现的 UTF-8 的 code point 索引（从0开始）。如果不存在子字符串，返回 -1。参数形式为：[目标字符串表达式, 子字符串表达式, 开始位置,
         * 					结束位置]
         *
    ...
    interface ZipOptions {
        ...
        /**
         * 一个数组，用于指定在输入数组长度不一的情况下时采用的数组各元素默认值。指定这个字段则必须指定 useLongestLength，否则返回错误。如果 useLongestLength 是 true 但是
    ...
    interface CollectionReference {
         ...
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=新增文档](http://uniapp.dcloud.io/uniCloud/cf-database?id=新增文档)
         */
        add(data: any): any;
        /**
         * 获取记录数据，或获取根据查询条件筛选后的记录数据
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=查询文档](http://uniapp.dcloud.io/uniCloud/cf-database?id=查询文档)
         */
        get(data: GetParam): any;
        /**
         * 统计匹配查询条件的记录的条数
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=获取查询数量](http://uniapp.dcloud.io/uniCloud/cf-database?id=获取查询数量)
         */
        count(): any;
        /**
         * 指定查询条件，返回带新查询条件的新的集合引用
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=添加查询条件](http://uniapp.dcloud.io/uniCloud/cf-database?id=添加查询条件)
         */
        where(query: string | string): Query;
        /**
         * 指定查询排序条件
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=对结果排序](http://uniapp.dcloud.io/uniCloud/cf-database?id=对结果排序)
         */
        orderBy(fieldPath: string | string, directionStr: 'desc' | 'asc'): Query;
        /**
         * 指定查询结果集数量上限
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=设置记录数量](http://uniapp.dcloud.io/uniCloud/cf-database?id=设置记录数量)
         */
        limit(limit: number): Query;
        /**
         * 指定查询返回结果时从指定序列后的结果开始返回，常用于分页
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=设置起始位置](http://uniapp.dcloud.io/uniCloud/cf-database?id=设置起始位置)
         */
        skip(offset: number): Query;
        /**
         * 更新多条记录
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=更新指定文档](http://uniapp.dcloud.io/uniCloud/cf-database?id=更新指定文档)
         */
        update(data: any): any;
        /**
         * 指定返回结果中记录需返回的字段
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=指定返回字段](http://uniapp.dcloud.io/uniCloud/cf-database?id=指定返回字段)
         */
         ...
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=删除文档](http://uniapp.dcloud.io/uniCloud/cf-database?id=删除文档)
         */
        remove(): any;
        /**
         * 获取数据库集合的聚合操作实例
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=聚合操作](http://uniapp.dcloud.io/uniCloud/cf-database?id=聚合操作)
         */
    ...
    interface DocumentReference {
         ...
         * 替换更新一条记录
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=更新文档，如果不存在则创建](http://uniapp.dcloud.io/uniCloud/cf-database?id=更新文档，如果不存在则创建)
         */
        set(data: any): any;
        /**
         * 更新一条记录
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=批量更新文档](http://uniapp.dcloud.io/uniCloud/cf-database?id=批量更新文档)
         */
        update(data: any): any;
        /**
         * 删除一条记录
    ...
    interface AggregateReference {
        /**
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=addfields](http://uniapp.dcloud.io/uniCloud/cf-database?id=addfields)
         */
        addFields(addFieldsOptions: any): AggregateReference;
        /**
         * 将输入记录根据给定的条件和边界划分成不同的组，每组即一个bucket
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=bucket](http://uniapp.dcloud.io/uniCloud/cf-database?id=bucket)
         */
         ...
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=bucketAuto](http://uniapp.dcloud.io/uniCloud/cf-database?id=bucketAuto)
         */
         ...
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=group](http://uniapp.dcloud.io/uniCloud/cf-database?id=group)
         */
         ...
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=lookup](http://uniapp.dcloud.io/uniCloud/cf-database?id=lookup)
         */
        lookup(lookupOptions: LookupOptions): AggregateReference;
        /**
         * 根据条件过滤文档，并且把符合条件的文档传递给下一个流水线阶段。
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=match](http://uniapp.dcloud.io/uniCloud/cf-database?id=match)
         */
        match(matchOptions: any): AggregateReference;
        /**
         * 把指定的字段传递给下一个流水线，指定的字段可以是某个已经存在的字段，也可以是计算出来的新字段。
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=project](http://uniapp.dcloud.io/uniCloud/cf-database?id=project)
         */
        project(projectOptions: any): AggregateReference;
        /**
         * 指定一个已有字段作为输出的根节点，也可以指定一个计算出的新字段作为根节点。
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=replaceroot](http://uniapp.dcloud.io/uniCloud/cf-database?id=replaceroot)
         */
        replaceRoot(replaceRootOptions: ReplaceRootOptions): AggregateReference;
        /**
         * 随机从文档中选取指定数量的记录。
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=sample](http://uniapp.dcloud.io/uniCloud/cf-database?id=sample)
         */
         ...
         * 根据指定的字段，对输入的文档进行排序。
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=sort](http://uniapp.dcloud.io/uniCloud/cf-database?id=sort)
         */
        sort(sortOptions: any): AggregateReference;
        /**
         * 根据指定的字段，对输入的文档进行排序。
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=sortbycount](http://uniapp.dcloud.io/uniCloud/cf-database?id=sortbycount)
         */
        sortByCount(sortByCountOptions: string): AggregateReference;
        /**
         * 使用指定的数组字段中的每个元素，对文档进行拆分。拆分后，文档会从一个变为一个或多个，分别对应数组的每个元素。
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=unwind](http://uniapp.dcloud.io/uniCloud/cf-database?id=unwind)
         */
        unwind(unwindOptions: UnwindOptions | string): void;
        /**
         * 标志聚合操作定义完成，发起实际聚合操作
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=end](http://uniapp.dcloud.io/uniCloud/cf-database?id=end)
         */
        end(): any;
    }
    ...
    interface LookupOptions {
        ...
        as: string;
        /**
         * 可选。指定在 pipeline 中可以使用的变量，变量的值可以引用输入记录的字段，比如 let: { userName: '$name' } 就代表将输入记录的 name 字段作为变量 userName
         * 					的值。在 pipeline 中无法直接访问输入记录的字段，必须通过 let 定义之后才能访问，访问的方式是在 expr 操作符中用 $$变量名 的方式访问，比如 $$userName。
         */
        let: any;
        /**
         * 指定要在被连接集合中运行的聚合操作。如果要返回整个集合，则该字段取值空数组 []。在 pipeline 中无法直接访问输入记录的字段，必须通过 let 定义之后才能访问，访问的方式是在 expr
    ...
    interface BucketOptions {
        /**
         * 一个用以决定分组的表达式，会应用在各个输入记录上。可以用 $ 前缀加上要用以分组的字段路径来作为表达式。除非用 default 指定了默认值，否则每个记录都需要包含指定的字段，且字段值必须在
         * 					boundaries 指定的范围之内。
         */
        groupBy: string;
        /**
    ...
    interface Query {
         ...
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=查询文档](http://uniapp.dcloud.io/uniCloud/cf-database?id=查询文档)
         */
        get(getOne: boolean, getCount: boolean): any;
        /**
         * 统计匹配查询条件的记录的条数
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=获取查询数量](http://uniapp.dcloud.io/uniCloud/cf-database?id=获取查询数量)
    ...
    interface UniCloud {
         ...
         * 调用云函数
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-functions?id=客户端调用云函数](http://uniapp.dcloud.io/uniCloud/cf-functions?id=客户端调用云函数)
         */
         ...
         * 获取数据库实例
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=获取数据库的引用](http://uniapp.dcloud.io/uniCloud/cf-database?id=获取数据库的引用)
         */
        database(): Db;
        /**
         * 获取当前用户缓存在token内的信息
    ...
    interface UniCloudOptions {
        ...
        /**
         * 是否启用云函数日志输出，仅开发阶段生效，平台支持：APP、H5
         * - true: 开启云函数日志输出
         * - false: 关闭云函数日志输出
         */
        debugFunction?: 'true' | 'false';
    }
